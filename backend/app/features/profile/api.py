...
@user_router.get("/{user_id}/trips", response_model=list[HistoryTripResponse])
...
@trip_router.post("/{trip_id}/feedback", response_model=TripFeedback)
def upsert_feedback(
    trip_id: str,
...
@trip_router.get("/{trip_id}/feedback", response_model=TripFeedback)
