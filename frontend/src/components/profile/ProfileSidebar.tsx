...
const COPY = {
  ...
  en: {
    ...
    profile: "Profile",
    profileHint: "Account, preferences and trips",
    memoir: "Personal memoir",
    memoirHint: "Photos uploaded on your travels",
  ...
  pt: {
    ...
    profile: "Perfil",
    profileHint: "Conta, preferências e viagens",
    memoir: "Memórias pessoais",
    memoirHint: "Fotografias das suas viagens",
