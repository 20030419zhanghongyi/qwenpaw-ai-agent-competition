...
const SHARED_COPY = {
  "zh-CN": {
    ...
    mappingHint: "先选择一个标签，再选择与它配对的观察项。也可以直接使用每项下方的选择框。", mappingStepOne: "第一步：选择标签", mappingStepTwo: "第二步：选择观察项", accessibleSelection: "无障碍选择方式", notSelected: "未选择",
    ...
    storyInvitation: "{title}故事游邀请", coloaneAudioStory: "路环声音故事游", limitedStory: "限定故事游", macauStory: "澳门故事游", invitationBody: "实地故事可随时查看提示，也可以跳过谜题继续游览。", enterStory: "进入《{title}》", continuePlanner: "继续普通路线规划",
  ...
  "zh-TW": {
    ...
    mappingHint: "先選擇一個標籤，再選擇與它配對的觀察項。亦可直接使用每項下方的選單。", mappingStepOne: "第一步：選擇標籤", mappingStepTwo: "第二步：選擇觀察項", accessibleSelection: "無障礙選擇方式", notSelected: "未選擇",
    ...
    storyInvitation: "{title}故事遊邀請", coloaneAudioStory: "路環聲音故事遊", limitedStory: "限定故事遊", macauStory: "澳門故事遊", invitationBody: "實地故事可隨時查看提示，亦可略過謎題繼續遊覽。", enterStory: "進入《{title}》", continuePlanner: "繼續一般路線規劃",
  ...
  en: {
    ...
    mappingHint: "Choose a label, then the observation that matches it. You can also use the select menus below.", mappingStepOne: "Step 1: choose a label", mappingStepTwo: "Step 2: choose an observation", accessibleSelection: "Accessible selection", notSelected: "Not selected",
    ...
    storyInvitation: "Invitation to {title}", coloaneAudioStory: "Coloane audio story walk", limitedStory: "Limited story walk", macauStory: "Macau story walk", invitationBody: "Hints are available at every stop, and puzzles can be skipped while you continue the walk.", enterStory: "Enter “{title}”", continuePlanner: "Continue regular route planning",
  ...
  pt: {
    ...
    mappingHint: "Escolha uma etiqueta e depois a observação correspondente. Também pode usar os menus abaixo.", mappingStepOne: "Passo 1: escolha uma etiqueta", mappingStepTwo: "Passo 2: escolha uma observação", accessibleSelection: "Seleção acessível", notSelected: "Não selecionado",
