...
const SHARED_COPY = {
  "zh-CN": {
    ...
    storyImage: "故事图片", imageAsset: "图片素材", viewLargeImage: "查看大图", viewLargeImageNamed: "查看大图：{label}", largeImageNamed: "大图：{label}", closeLargeImage: "关闭大图", unregisteredImage: "未登记的图片素材", imageUnavailable: "图片素材暂未提供", namedImageUnavailable: "{label}暂未提供",
    ...
    kindHistorical: "史实", kindFolklore: "民间信俗／地方记忆", kindReconstruction: "语境化重建", kindFiction: "剧情虚构", kindOperational: "动态营运信息",
    rewardStamp: "印记", rewardCapability: "能力", rewardCoordinate: "坐标", rewardStoryProp: "故事道具", rewardPetal: "密笺花瓣", rewardCollection: "完整收藏", rewardReflection: "今日补记", rewardLetter: "退信盒来信", rewardRecord: "工作簿记录", acceptAndNext: "收下并查看下一站", petalsBecomeFlower: "五瓣成花", chapterRewards: "章节收获", flowerRewardAria: "五张密笺组成完整市花", storyRewardAria: "获得故事奖励", acceptFifthPetal: "收下第五瓣密笺", fifthPetalHint: "确认收下后，将集齐所有五瓣密笺。", flowerRevealAria: "五张密笺花瓣依次重合，组成完整澳门市花", flowerRevealBody: "五瓣已经集齐，五张密笺迎光组成完整市花。",
    ...
    mappingHint: "先选择一个标签，再选择与它配对的观察项。也可以直接使用每项下方的选择框。", mappingStepOne: "第一步：选择标签", mappingStepTwo: "第二步：选择观察项", accessibleSelection: "无障碍选择方式", notSelected: "未选择", mappingAccessibleInstructions: "每个标签选择一项；选项文字会完整换行显示。", mappingPairedTo: "已配对给“{label}”",
  ...
  "zh-TW": {
    ...
    storyImage: "故事圖片", imageAsset: "圖片素材", viewLargeImage: "查看大圖", viewLargeImageNamed: "查看大圖：{label}", largeImageNamed: "大圖：{label}", closeLargeImage: "關閉大圖", unregisteredImage: "未登記的圖片素材", imageUnavailable: "圖片素材暫未提供", namedImageUnavailable: "{label}暫未提供",
    ...
    kindHistorical: "史實", kindFolklore: "民間信俗／地方記憶", kindReconstruction: "語境化重建", kindFiction: "劇情虛構", kindOperational: "動態營運資訊",
    rewardStamp: "印記", rewardCapability: "能力", rewardCoordinate: "座標", rewardStoryProp: "故事道具", rewardPetal: "密箋花瓣", rewardCollection: "完整收藏", rewardReflection: "今日補記", rewardLetter: "退信盒來信", rewardRecord: "工作簿紀錄", acceptAndNext: "收下並查看下一站", petalsBecomeFlower: "五瓣成花", chapterRewards: "章節收穫", flowerRewardAria: "五張密箋組成完整市花", storyRewardAria: "獲得故事獎勵", acceptFifthPetal: "收下第五瓣密箋", fifthPetalHint: "確認收下後，將集齊所有五瓣密箋。", flowerRevealAria: "五張密箋花瓣依次重合，組成完整澳門市花", flowerRevealBody: "五瓣已經集齊，五張密箋迎光組成完整市花。",
    ...
    mappingHint: "先選擇一個標籤，再選擇與它配對的觀察項。亦可直接使用每項下方的選項。", mappingStepOne: "第一步：選擇標籤", mappingStepTwo: "第二步：選擇觀察項", accessibleSelection: "無障礙選擇方式", notSelected: "未選擇", mappingAccessibleInstructions: "每個標籤選擇一項；選項文字會完整換行顯示。", mappingPairedTo: "已配對給「{label}」",
  ...
  en: {
    ...
    kindHistorical: "Historical fact", kindFolklore: "Folk belief / local memory", kindReconstruction: "Contextual reconstruction", kindFiction: "Fictional narrative", kindOperational: "Live visitor information",
    rewardStamp: "Stamp", rewardCapability: "Ability", rewardCoordinate: "Coordinate", rewardStoryProp: "Story item", rewardPetal: "Secret-note petal", rewardCollection: "Complete collection", rewardReflection: "Today’s note", rewardLetter: "Returned-box letter", rewardRecord: "Workbook entry", acceptAndNext: "Collect and view next stop", petalsBecomeFlower: "Five petals, one flower", chapterRewards: "Chapter rewards", flowerRewardAria: "Five secret notes form the complete city flower", storyRewardAria: "Story reward received", acceptFifthPetal: "Collect the fifth petal", fifthPetalHint: "Collect it to complete all five secret-note petals.", flowerRevealAria: "Five secret-note petals overlap to form Macau’s city flower", flowerRevealBody: "All five petals are together, forming the complete city flower in the light.",
    ...
    mappingHint: "Choose a label, then the observation that matches it. You can also use the choices below.", mappingStepOne: "Step 1: choose a label", mappingStepTwo: "Step 2: choose an observation", accessibleSelection: "Accessible selection", notSelected: "Not selected", mappingAccessibleInstructions: "Choose one item for each label. Long option text wraps within the card.", mappingPairedTo: "Already paired with “{label}”",
  ...
  pt: {
    ...
    kindHistorical: "Facto histórico", kindFolklore: "Crença popular / memória local", kindReconstruction: "Reconstrução contextual", kindFiction: "Narrativa ficcional", kindOperational: "Informação atual ao visitante",
    rewardStamp: "Marca", rewardCapability: "Capacidade", rewardCoordinate: "Coordenada", rewardStoryProp: "Objeto da história", rewardPetal: "Pétala do bilhete secreto", rewardCollection: "Coleção completa", rewardReflection: "Nota de hoje", rewardLetter: "Carta devolvida", rewardRecord: "Registo do caderno", acceptAndNext: "Guardar e ver próxima paragem", petalsBecomeFlower: "Cinco pétalas, uma flor", chapterRewards: "Recompensas do capítulo", flowerRewardAria: "Cinco bilhetes secretos formam a flor completa", storyRewardAria: "Recompensa da história recebida", acceptFifthPetal: "Guardar a quinta pétala", fifthPetalHint: "Ao guardá-la, completa as cinco pétalas dos bilhetes secretos.", flowerRevealAria: "Cinco pétalas dos bilhetes secretos formam a flor de Macau", flowerRevealBody: "As cinco pétalas estão reunidas e formam a flor completa à luz.",
    ...
    mappingHint: "Escolha uma etiqueta e depois a observação correspondente. Também pode usar as opções abaixo.", mappingStepOne: "Passo 1: escolha uma etiqueta", mappingStepTwo: "Passo 2: escolha uma observação", accessibleSelection: "Seleção acessível", notSelected: "Não selecionado", mappingAccessibleInstructions: "Escolha um item para cada etiqueta. O texto longo é ajustado dentro do cartão.", mappingPairedTo: "Já associado a «{label}»",
    ...
    storyInvitation: "Convite para {title}", coloaneAudioStory: "Percurso áudio de Coloane", taipaLetterStory: "Percurso de cartas da Taipa", limitedStory: "Percurso especial", macauStory: "Percurso de histórias de Macau", invitationBody: "Há pistas em cada paragem e pode saltar enigmas sem interromper o percurso.", enterStory: "Entrar em «{title}»", continuePlanner: "Continuar o planeamento normal",
